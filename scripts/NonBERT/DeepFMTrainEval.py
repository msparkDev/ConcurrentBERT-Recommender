...
from BERT.BERTWithEval import calculate_ndcg

# Load Data
def load_data():
    train = pd.read_csv('data/DeepFM_SinglePurchases/trainForDF_WOCP.csv')
    val = pd.read_csv('data/DeepFM_SinglePurchases/valForDF_WOCP.csv')
    test = pd.read_csv('data/DeepFM_SinglePurchases/testForDF_WOCP.csv')
