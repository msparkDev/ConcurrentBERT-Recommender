...
# Assuming calculate_ndcg from BERT.BERTEval is already defined and imported
# from BERT.BERTEval import calculate_ndcg
...
# Main Execution Flow
# Assuming 'data/DeepFM_ConcurrentPurchases/' contains the combined dataset
combined_data = pd.read_csv('data/DeepFM_ConcurrentPurchases/combined_data.csv')
sparse_features = ['C' + str(i) for i in range(1, 7)]  # Define sparse features
