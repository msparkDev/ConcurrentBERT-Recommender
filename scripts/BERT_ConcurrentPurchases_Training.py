...
tokenizer = BertTokenizer.from_pretrained(model_ckpt, do_lower=False)
...
training_args = TrainingArguments(
    output_dir="YourUsernameHere/ConcurrentPurchasesBERT-UCIRetailTuned",  # Customize with your Hugging Face username.
    num_train_epochs=3,
    learning_rate=2e-5,
